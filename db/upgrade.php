...
function xmldb_emarking_upgrade($oldversion) {
    ...
    if ($oldversion < 2016050800) {
        ...
        $table = new xmldb_table('emarking_exams');
        $field = new xmldb_field('filetoprint', XMLDB_TYPE_INTEGER, '10', null, null, null, null, 'comment');    
        // Conditionally launch add field filetoprint.
        if (!$dbman->field_exists($table, $field)) {
            $dbman->add_field($table, $field);
        }
        // Emarking savepoint reached.
        upgrade_mod_savepoint(true, 2016050800, 'emarking');
    }
    if ($oldversion < 2016051500) {
        // Update all exams to new statuses.
        $DB->execute('UPDATE {emarking_exams} SET status = status * 10');
        // Emarking savepoint reached.
    ...
    $table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
    $table->add_field('title', XMLDB_TYPE_CHAR, '500', null, XMLDB_NOTNULL, null, null);
    $table->add_field('description', XMLDB_TYPE_TEXT, null, null, null, null, null);
    $table->add_field('learningobjectives', XMLDB_TYPE_CHAR, '500', null, XMLDB_NOTNULL, null, null);
    $table->add_field('comunicativepurpose', XMLDB_TYPE_CHAR, '250', null, XMLDB_NOTNULL, null, null);
    $table->add_field('genre', XMLDB_TYPE_CHAR, '500', null, XMLDB_NOTNULL, null, null);
    $table->add_field('audience', XMLDB_TYPE_CHAR, '500', null, null, null, null);
    $table->add_field('estimatedtime', XMLDB_TYPE_INTEGER, '5', null, XMLDB_NOTNULL, null, null);
    $table->add_field('instructionstudents', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
    $table->add_field('teaching', XMLDB_TYPE_TEXT, null, null, XMLDB_NOTNULL, null, null);
    $table->add_field('teachingsuggestions', XMLDB_TYPE_TEXT, null, null, null, null, null);
    $table->add_field('languageresources', XMLDB_TYPE_TEXT, null, null, null, null, null);
    $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    ...
    if ($oldversion < 2016090800) {
    	...
    	// Define field teaching to be dropped from emarking_activities.
    	$table = new xmldb_table('emarking_activities');
    	$field = new xmldb_field('teaching');
    
    	// Conditionally launch drop field teaching.
    	if ($dbman->field_exists($table, $field)) {
    		$dbman->drop_field($table, $field);
    	}
    
    	// Emarking savepoint reached.
    	upgrade_mod_savepoint(true, 2016090800, 'emarking');
    }
    if ($oldversion < 2016090801) {
    
    	// Rename field teaching on table emarking_activities to NEWNAMEGOESHERE.
    	$table = new xmldb_table('emarking_activities');
    	$field = new xmldb_field('teachingsuggestions', XMLDB_TYPE_TEXT, null, null, null, null, null, 'instructions');
    
    	// Launch rename field teaching.
    	$dbman->rename_field($table, $field, 'teaching');
    
    	$field = new xmldb_field('instructionstudents', XMLDB_TYPE_TEXT, null, null, null, null, null, 'instructions');
    	
    	// Launch rename field teaching.
    	$dbman->rename_field($table, $field, 'instructions');
    	// Emarking savepoint reached.
    	upgrade_mod_savepoint(true, 2016090801, 'emarking');
    }
    if ($oldversion < 2016090802) {
    
    	// Define table emarking_activity_draft to be created.
    	$table = new xmldb_table('emarking_activity_draft');
    
    	// Adding fields to table emarking_activity_draft.
    	$table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
    	$table->add_field('userid', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('activityid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('timecreated', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('edited', XMLDB_TYPE_INTEGER, '2', null, XMLDB_NOTNULL, null, null);
    
    	// Adding keys to table emarking_activity_draft.
    	$table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
    
    	// Conditionally launch create table for emarking_activity_draft.
    	if (!$dbman->table_exists($table)) {
    		$dbman->create_table($table);
    	}
    
    	// Emarking savepoint reached.
    	upgrade_mod_savepoint(true, 2016090802, 'emarking');
    }
    if ($oldversion < 2016090803) {
    
    	// Define table emarking_edited_activities to be created.
    	$table = new xmldb_table('emarking_edited_activities');
    
    	// Adding fields to table emarking_edited_activities.
    	$table->add_field('id', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
    	$table->add_field('activityid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('timecreated', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('timemodified', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    	$table->add_field('teaching', XMLDB_TYPE_BINARY, null, null, XMLDB_NOTNULL, null, null);
    	$table->add_field('instructions', XMLDB_TYPE_BINARY, null, null, XMLDB_NOTNULL, null, null);
    	$table->add_field('languageresources', XMLDB_TYPE_BINARY, null, null, XMLDB_NOTNULL, null, null);
    	$table->add_field('rubricid', XMLDB_TYPE_INTEGER, '20', null, XMLDB_NOTNULL, null, null);
    
    	// Adding keys to table emarking_edited_activities.
    	$table->add_key('primary', XMLDB_KEY_PRIMARY, array('id'));
    
    	// Conditionally launch create table for emarking_edited_activities.
    	if (!$dbman->table_exists($table)) {
    		$dbman->create_table($table);
    	}
